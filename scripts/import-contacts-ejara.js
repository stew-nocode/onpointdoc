...
/**
 * Script d'import des contacts clients EJARA
 * 
 * Usage: node scripts/import-contacts-ejara.js
 * 
...
// Données des contacts EJARA
const contactsData = [
  { "Nom Complet": "Ousseyni Oumarou", "Email": "ousseyni.oumarou@ejara.io", "Rôle": "" },
  { "Nom Complet": "Mr KOFFI", "Email": "", "Rôle": "" },
  { "Nom Complet": "Mme SOPPI", "Email": "", "Rôle": "" },
  { "Nom Complet": "Tous les clients", "Email": "", "Rôle": "" }
  // Note: "OUMAROU" avec le même email semble être un doublon, on l'ignore
];

async function importContacts() {
  console.log(`\n🔍 Recherche de l'entreprise EJARA...\n`);

  // Récupérer l'ID de l'entreprise EJARA
  ...
  if (companyErr || !companies || companies.length === 0) {
    console.error(`❌ Entreprise EJARA non trouvée`);
  ...
  const ejaraCompany = companies[0];
  console.log(`✅ Entreprise EJARA trouvée (ID: ${ejaraCompany.id}, Nom: ${ejaraCompany.name})\n`);
