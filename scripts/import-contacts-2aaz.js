...
/**
 * Script d'import des contacts clients 2AAZ
 * 
 * Usage: node scripts/import-contacts-2aaz.js
 * 
...
// Données des contacts 2AAZ
const contactsData = [
  { "Nom Complet": "MARCELLE AHOUSSOU", "Email": "marcelle.ahoussou@2aaz.ci", "Rôle": "Actionnaire principale" },
  { "Nom Complet": "CHRISTELLE NGBECHE", "Email": "christelle.ngbeche@2aaz.ci", "Rôle": "Administrateur général" }
];

async function importContacts() {
  console.log(`\n🔍 Recherche de l'entreprise 2AAZ...\n`);

  // Récupérer l'ID de l'entreprise 2AAZ
  ...
  if (companyErr || !companies || companies.length === 0) {
    console.error(`❌ Entreprise 2AAZ non trouvée`);
  ...
  const company2aaz = companies[0];
  console.log(`✅ Entreprise 2AAZ trouvée (ID: ${company2aaz.id}, Nom: ${company2aaz.name})\n`);
