...
/**
 * Script d'import des contacts clients SIS
 * 
 * Usage: node scripts/import-contacts-sis.js
 */
...
const contactsData = [
  { "Nom Complet": "SIE", "Email": "", "Rôle": "" },
  { "Nom Complet": "COFFIE", "Email": "", "Rôle": "" },
  { "Nom Complet": "KONE HASSANE", "Email": "sis@cclint.com", "Rôle": "Directeur Technique" },
  { "Nom Complet": "ESTELLE KANGA", "Email": "kangaahouestellebenedicte@gmail.com", "Rôle": "Gestionnaire de stock" },
  { "Nom Complet": "KHATTAR CAMIL", "Email": "ckhattar@cclint.com", "Rôle": "" }
];

async function importContacts() {
  console.log(`\n🔍 Recherche de l'entreprise SIS...\n`);
  ...
  if (companyErr || !companies || companies.length === 0) {
    console.error(`❌ Entreprise SIS non trouvée`);
    console.error(`   Erreur: ${companyErr?.message || 'Entreprise introuvable'}`);
    process.exit(1);
  }

  const sisCompany = companies[0];
  console.log(`✅ Entreprise SIS trouvée (ID: ${sisCompany.id}, Nom: ${sisCompany.name})\n`);
