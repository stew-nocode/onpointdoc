...
/**
 * Script d'import des contacts clients EGBV
 * 
 * Usage: node scripts/import-contacts-egbv.js
 * 
...
// Données des contacts EGBV
const contactsData = [
  { "Nom Complet": "Roselin Tiecoura", "Email": "tiecoura@egbvinternational.com", "Rôle": "Informaticien" },
  { "Nom Complet": "Amary TCHOTCHE", "Email": "tchotcheamary@egbvinternational.com", "Rôle": "Responsable IT" },
  { "Nom Complet": "HILARION YAO", "Email": "compta.junior@egbvinternational.com", "Rôle": "Assistant Comptable" },
  { "Nom Complet": "ERIC ATSE", "Email": "sanckatse@egbvinter.com", "Rôle": "" },
  { "Nom Complet": "MONSIEUR ADOU", "Email": "", "Rôle": "" },
  { "Nom Complet": "MADAME CISSE", "Email": "", "Rôle": "" },
  { "Nom Complet": "Madame ADJA", "Email": "", "Rôle": "" },
  { "Nom Complet": "TOHOURI CAROLE", "Email": "tohouri.carole@egbvinternational.com", "Rôle": "" }
];

async function importContacts() {
  console.log(`\n🔍 Recherche de l'entreprise EGBV...\n`);

  // Récupérer l'ID de l'entreprise EGBV
  ...
  if (companyErr || !companies || companies.length === 0) {
    console.error(`❌ Entreprise EGBV non trouvée`);
  ...
  const egbvCompany = companies[0];
  console.log(`✅ Entreprise EGBV trouvée (ID: ${egbvCompany.id}, Nom: ${egbvCompany.name})\n`);
    ...
    try {
      ...
      const { data, error } = await supabase
        ...
        .insert({
          ...
          full_name: fullName,
          role: 'client',
          company_id: egbvCompany.id,
          job_title: jobTitle, // Fonction/poste de travail (peut être NULL)
