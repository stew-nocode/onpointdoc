...
/**
 * Script d'import des contacts clients ARIC
 * 
 * Usage: node scripts/import-contacts-aric.js
 * 
...
// Données des contacts ARIC
const contactsData = [
  { "Nom Complet": "Sanankoua Mickaelle", "Email": "mickaelle.sanankoua@rica-services.com", "Rôle": "Directeur des Ressources Humaines" },
  { "Nom Complet": "Fidel Benao", "Email": "fbenao@rica-services.com", "Rôle": "Chef comptable" },
  { "Nom Complet": "Kramo", "Email": "fkramo@rica-services.com", "Rôle": "Coordinateur Finance Comptabilité" },
  { "Nom Complet": "Tapé Thibault Julien", "Email": "ttape@rica-services.com", "Rôle": "Chef comptable" },
  { "Nom Complet": "NADIA CISSE", "Email": "nadia.cisse@rica-services.com", "Rôle": "Responsable Administrative" },
  { "Nom Complet": "NDADJI Koua Henry Michel", "Email": "hmndadji@rica-services.com", "Rôle": "Planificateur SAV Maintenance" },
  { "Nom Complet": "SERIGNE DIOME", "Email": "serigne.diome@rica-services.com", "Rôle": "Directeur Général Adjoint" }
];

async function importContacts() {
  console.log(`\n🔍 Recherche de l'entreprise ARIC...\n`);

  // Récupérer l'ID de l'entreprise ARIC
  ...
  if (companyErr || !companies || companies.length === 0) {
    console.error(`❌ Entreprise ARIC non trouvée`);
  ...
  const aricCompany = companies[0];
  console.log(`✅ Entreprise ARIC trouvée (ID: ${aricCompany.id}, Nom: ${aricCompany.name})\n`);
