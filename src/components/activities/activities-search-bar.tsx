...
type ActivitiesSearchBarProps = {
  initialSearch?: string;
  className?: string;
};

/**
 * Composant de barre de recherche pour les activités
 * 
 * Pattern similaire à TicketsSearchBar pour cohérence
 * 
 ...
 */
export function ActivitiesSearchBar({ initialSearch, className }: ActivitiesSearchBarProps) {
  ...
  useEffect(() => {
    ...
    const newUrl = params.toString() 
      ? `/gestion/activites?${params.toString()}`
      : '/gestion/activites';
    ...
    <div className={cn("relative w-full", className)}>
      <div className="relative">
        ...
        <input
          ...
          placeholder="Rechercher par titre d'activité..."
