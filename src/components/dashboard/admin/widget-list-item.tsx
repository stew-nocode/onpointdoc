...
/**
 * Item de liste pour un widget (utilisé dans la configuration admin)
 */
export function WidgetListItem({ widgetId, isSelected, onToggle }: WidgetListItemProps) {
