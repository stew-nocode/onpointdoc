/**
 * Dialog pour éditer le compte rendu d'une tâche
 * 
 * Réutilise la logique similaire à EditActivityReportDialog pour la cohérence
...
type EditTaskReportDialogProps = {
  /**
 ...
 */
export function EditTaskReportDialog({
  taskId,
  currentReportContent,
  onSubmit,
  open,
  onOpenChange
}: EditTaskReportDialogProps) {
