...
type CampaignsSearchBarProps = {
  initialSearch?: string;
  className?: string;
};

/**
 * Composant de barre de recherche pour les campagnes email
 * 
 * Pattern similaire à TasksSearchBar et ActivitiesSearchBar pour cohérence
 * 
 ...
 */
export function CampaignsSearchBar({ initialSearch, className }: CampaignsSearchBarProps) {
  ...
  useEffect(() => {
    ...
    const newUrl = params.toString() 
      ? `/marketing/email?${params.toString()}`
      : '/marketing/email';
    ...
    <div className={cn("relative w-full", className)}>
      <div className="relative">
        ...
        <input
          ...
          placeholder="Rechercher par nom ou sujet de campagne..."
