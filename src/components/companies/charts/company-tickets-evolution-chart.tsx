...
import type { CompanyTicketsEvolutionStats, CompanyDataGranularity } from '@/services/companies/stats/company-tickets-evolution-stats';
import {
  CHART_MARGIN,
  ANIMATION_DURATION,
  ANIMATION_EASING,
...
type CompanyTicketsEvolutionChartProps = {
  data: CompanyTicketsEvolutionStats | null;
  className?: string;
};
 ...
 */
const GRANULARITY_DESCRIPTION: Record<CompanyDataGranularity, string> = {
  day: 'Par jour',
  week: 'Par semaine',
  month: 'Par mois',
};
...
/**
 * Chart - Évolution des tickets pour une entreprise (AreaChart avec dégradés)
 *
 * Affiche la tendance des tickets créés avec une granularité adaptative.
 * Pattern identique au dashboard pour cohérence UI/UX.
 *
 * @see src/components/dashboard/charts/tickets-evolution-chart.tsx
 */
export function CompanyTicketsEvolutionChart({ 
  data, 
  className 
}: CompanyTicketsEvolutionChartProps) {
  ...
  if (!data || data.data.length === 0) {
    return <CompanyTicketsEvolutionChartEmpty className={className} />;
  }
        ...
        <ChartContainer config={chartConfig} className="h-[280px] w-full">
          ...
          >
            ...
            <defs>
              ...
              <linearGradient id="gradientAssistanceCompany" x1="0" y1="0" x2="0" y2="1">
              ...
              {/* Dégradé REQ (Blue) */}
              <linearGradient id="gradientReqCompany" x1="0" y1="0" x2="0" y2="1">
              ...
              {/* Dégradé BUG (Rose) */}
              <linearGradient id="gradientBugCompany" x1="0" y1="0" x2="0" y2="1">
            ...
            <Area
              ...
              strokeWidth={2}
              fill="url(#gradientAssistanceCompany)"
 ...
 * État vide du chart
 */
function CompanyTicketsEvolutionChartEmpty({ className }: { className?: string }) {
  return (
    <Card 
      className={cn(
        'border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950',
 ...
 */
export function CompanyTicketsEvolutionChartSkeleton({ className }: { className?: string }) {
  return (
    <Card 
      className={cn(
