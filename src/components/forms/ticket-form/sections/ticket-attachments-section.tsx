/**
 * Section Pièces Jointes du formulaire de ticket
 * 
...
type TicketAttachmentsSectionProps = {
...
/**
 * Section pour gérer les pièces jointes (drag & drop ou sélection)
 * 
 * @param selectedFiles - Liste des fichiers sélectionnés
 * @param isDragging - État du drag & drop
 * @param fileInputRef - Référence vers l'input file
 * @param onDragOver - Handler pour drag over
 * @param onDragLeave - Handler pour drag leave
 * @param onDrop - Handler pour drop
 * @param onFileDialogOpen - Handler pour ouvrir le dialogue de fichier
 * @param onFileInputChange - Handler pour changement de fichier
 * @param onRemoveFile - Handler pour retirer un fichier
 */
      ...
      >
        <div className="flex flex-col items-center justify-center gap-2 text-center text-slate-600 dark:text-slate-300">
          <div className="flex h-12 w-12 items-center justify-center rounded-full bg-slate-100 text-slate-700 transition group-hover:bg-slate-200 dark:bg-slate-800 dark:text-slate-200">
            ...
            >
              <path
                ...
                strokeWidth="2"
                d="M7 16a4 4 0 118 0v1h1a3 3 0 110 6H6a3 3 0 110-6h1v-1z"
              />
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                strokeWidth="2"
                d="M12 12V3m0 0l-3 3m3-3l3 3"
              />
            </svg>
          </div>
          ...
          <div className="text-xs text-slate-500">
            Formats acceptés: images et PDF. 20 Mo max par fichier.
          </div>
        </div>
        <input
          ref={fileInputRef}
